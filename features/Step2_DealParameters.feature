Feature: Step2_DealParameters
  ...
  Scenario: Adding data
    ...
    Then it contains the following variables and values:
      ...
      | deal.intro.party2.full_Name                             | {{first_Name}} {{last_Name}}    |
      | deal.intro.party2.first_Name                            | Roberta                         |
      | deal.intro.party2.last_Name                             | Robinson                        |
      ...
      | deal.closing.sign_Party2.sign_Entity.full_Name          | {{first_Name}} {{last_Name}}    |
      | deal.closing.sign_Party2.sign_Entity.first_Name         | Roberta                         |
      | deal.closing.sign_Party2.sign_Entity.last_Name          | Robinson                        |
