...
<p>{{xnum}}.1.1. Amendment</p>
<p>This <a href="#Agreement">Agreement</a> may be amended, supplemented or otherwise modified only by a writing executed by the <a href="#Parties">Parties</a></p>
<p>{{xnum}}.2.2. Successors and Assigns</p>
...
This Agreement is the final, complete, and exclusive agreement of the Parties with respect to the subject matters hereof and supersedes and merges all prior discussions between the Parties with respect to such matters.<p>{{xnum}}.4.4. Notices</p>
...
<p>{{xnum}}.5.5. Interpretation to Make Valid</p>
...
`;
  ...
  it('lalalalala', function (done) {

    const file = __dirname + "/_test_NDA_Mutual.cmacc"

    const opts = {
      base: 'file://' + path.dirname(file) + '/'
    };

    const content = `// This is the part of the process where is shape the prose object into something closer to the deal. In this example a Mutual NDA
